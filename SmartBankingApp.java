...
public class SmartBankingApp {
        ...
        do{
            ...
            switch(screen){
                ...
                case DEPOSIT:{
                    ...
                    isValidAccountNo("Enter Account No: ");
                    if(!valid) continue;
                ...
                case WITHDRAW:{
                     ...
                     isValidWithdrawAmount("Withdraw Amount: ");
                     if (!valid) continue;
                ...
                case TRANSFER:{
                    isValidAccountNo("Enter from A/C No: ");
                    if(!valid) continue;
                    ...
                    isValidAccountNo("Enter to A/C No: ");
                    if(!valid) continue;
    ...
    public static void isValidAccountNo(String input){
        do{
    ...
    public static void isValidWithdrawAmount(String input){
        do{
            valid = true;
            System.out.print(input);
